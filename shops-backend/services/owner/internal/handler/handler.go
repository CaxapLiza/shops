...
import (
	...
	"github.com/student/shops/services/owner/internal/repository"
	"log"
	"net/http"
	"strconv"
)
...
func GetList(w http.ResponseWriter, r *http.Request) {
	...
	response, err := json.Marshal(owners)
	if err != nil {
...
func Create(w http.ResponseWriter, r *http.Request) {
	...
	owner := &internal.Owner{Name: requestBody.Name, Itn: requestBody.Itn, Passport: requestBody.Passport, Snils: requestBody.Snils, Phone: requestBody.Phone, AccountId: requestBody.AccountId}
	...
	response, err := json.Marshal(owner)
	if err != nil {
		http.Error(w, "Error encoding JSON", http.StatusInternalServerError)
		log.Println("JSON Error:", err)
		return
