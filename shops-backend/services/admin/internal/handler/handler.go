...
import (
	...
	"github.com/student/shops/services/admin/internal/repository"
...
func Create(w http.ResponseWriter, r *http.Request) {
	...
	admin := &internal.Admin{Name: requestBody.Name, Itn: requestBody.Itn, Passport: requestBody.Passport, Snils: requestBody.Snils, Phone: requestBody.Phone, AccountId: requestBody.AccountId}
